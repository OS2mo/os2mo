...
describe('EmployeeDetail.vue', () => {
  const dateA = '2020-01-01', dateB = '2020-12-31'
  ...
  let mountComponent = () => {
    ...
    const store = new Vuex.Store({
      getters: {
        'atDate/GET': () => { return dateA },
        'conf/GET_CONF_DB': () => { return { show_cpr_no: true } },
        'employee/GET_EMPLOYEE': () => { return { name: 'Firstname Lastname' } },
        'employee/GET_DETAILS': () => { return { name: 'Firstname Lastname' } },
      },
    })
