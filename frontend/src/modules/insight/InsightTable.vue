...
export default {
    ...
    methods: {
        ...
        downloadCSVData: function() {
            ...
            let csvContent = `data:text/csv;charset=utf-8,${this.$t('table_headers.employee_name')},${this.$t('table_headers.employee_email')},${this.$t('table_headers.manager_name')},${this.$t('table_headers.manager_email')},${this.$t('table_headers.department_name')}` + rows.map(row => {
