...
class AddressBase(MOBase):
    ...
    value: Optional[str] = Field(description="Optional second value of the address.")
...
class AddressRead(AddressBase):
    ...
    value2: Optional[str] = Field(
        description="Value of the address, e.g. street or phone number."
    )
...
class AddressWrite(AddressBase):
    ...
    validity: Optional[Validity] = Field(description="Validity of the address object.")
    address_type: ClassWrite = Field(
