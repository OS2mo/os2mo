...
class TestSettings(tests.cases.TestCase):
    def test_dict_key_intersection(self):
        ...
        d2 = {"config1": {"deprecated": 123, "not_deprecated": 456}, "config2": 789}

        expected = {"config1": {"deprecated": 123}}
    ...
    def test_dict_key_difference(self):
        ...
        d2 = {
            ...
            "config3": {
                "valid2": 654312,
                "invalid": 789,
                "invalid2": {"invalid3": 123456},
            },
        }

        expected = {"config3": {"invalid": 789, "invalid2": {"invalid3": 123456}}}
    ...
    def test_update_dict(self):
        base = {"config1": {"setting1": 123, "setting2": 456}, "config2": 789}
        new = {
            "config1": {"setting2": 999, "setting3": 111},
            "config2": 123,
            "config3": 123456,
        }
        ...
        expected = {
            "config1": {"setting1": 123, "setting2": 999, "setting3": 111},
            "config2": 123,
            "config3": 123456,
        }
