...
class Tests(util.LoRATestCase):
    ...
    def test_create_org_unit_fails_validation_outside_org_unit(self):
        ...
        self.assertRequest(
            ...
            json=payload,
            amqp_topics={'organisation.org_unit.create': 1},
        )
    ...
    def test_edit_org_unit_overwrite(self):
        ...
        self.assertRequestResponse(
            ...
            [org_unit_uuid],
            json=req,
            amqp_topics={'organisation.org_unit.update': 1},
        )
    ...
    def test_edit_org_unit_earlier_start_on_created(self, m):
        ...
        self.assertRequestResponse(
            ...
            amqp_topics={
                'organisation.org_unit.create': 1,
                'organisation.org_unit.update': 1,
            },
        )
    ...
    def test_edit_time_planning(self):
        ...
        self.assertRequestResponse(
            ...
            amqp_topics={'organisation.org_unit.update': 2},
        )
