...
class Tests(tests.cases.LoRATestCase):
    ...
    def test_terminate_org_unit_validations(self):
        ...
        for unitid in ("85715fc7-925d-401b-822d-467eb4b163b6",):
            self.assertRequestResponse(
                "/service/ou/{}/terminate".format(
                    unitid,
                ),
