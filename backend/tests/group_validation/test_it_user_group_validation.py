...
async def test_get_validation_item_from_mo_object(mo_object: dict):
...
def test_it_user_unique_validate_additional_object():
    obj = {
        "employee_uuid": "uuid",
        "it_system_uuid": "uuid",
...
def test_it_user_association_primary_validate_additional_object():
