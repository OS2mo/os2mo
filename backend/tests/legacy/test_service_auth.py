...
class AsyncTestAuthEndpointsReturn401(tests.legacy.cases.AsyncTestCase):
...
class TestAuthEndpointsReturn2xx(tests.legacy.cases.AsyncLoRATestCase):
    """
...
class TestTokenModel(tests.legacy.cases.TestCase):
...
@pytest.mark.usefixtures("sample_structures_minimal")
class TestUuidInvalidOrMissing(tests.legacy.cases.LoRATestCase):
...
class TestAuthDisabled(tests.legacy.cases.LoRATestCase):
    def setUp(self) -> None:
        super().setUp()
