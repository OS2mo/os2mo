...
class AsyncWriting(tests.legacy.cases.AsyncLoRATestCase):
    maxDiff = None
...
@pytest.mark.usefixtures("sample_structures")
@freezegun.freeze_time("2017-01-01", tz_offset=1)
class Writing(tests.legacy.cases.LoRATestCase):
    maxDiff = None
...
@freezegun.freeze_time("2017-01-01", tz_offset=1)
class AsyncReadingMinimal(tests.legacy.cases.AsyncLoRATestCase):
    @util.darmock("dawa-addresses.json", allow_mox=True, real_http=True)
...
@pytest.mark.usefixtures("sample_structures")
@freezegun.freeze_time("2017-01-01", tz_offset=1)
class AsyncReading(tests.legacy.cases.AsyncLoRATestCase):
...
@pytest.mark.usefixtures("sample_structures")
@freezegun.freeze_time("2017-01-01", tz_offset=1)
class Reading(tests.legacy.cases.LoRATestCase):
    @util.darmock("dawa-addresses.json", allow_mox=True, real_http=True)
