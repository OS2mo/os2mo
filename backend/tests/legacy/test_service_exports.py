...
class AuthTests(tests.legacy.cases.AsyncTestCase):
...
class FileTests(tests.legacy.cases.AsyncTestCase):
    maxDiff = None
...
class FileUploadTests(tests.legacy.cases.AsyncTestCase):
    maxDiff = None
