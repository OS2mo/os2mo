...
class AsyncTestHelper(tests.legacy.cases.AsyncLoRATestCase):
    maxDiff = None
...
@pytest.mark.usefixtures("sample_structures")
class TestHelper(tests.legacy.cases.LoRATestCase):
    maxDiff = None
    ORG = "456362c4-0ee4-4e5e-a72c-751239745e62"
    SAMF_UNIT = "b688513d-11f7-4efc-b679-ab082a2055d0"
    HIST_UNIT = "da77153e-30f3-4dc2-a611-ee912a28d8aa"
...
class AsyncTestValidator(AsyncTestHelper):
    async def test_should_return_true_when_interval_contained(self):
        """
        [------ super ------)
           [--- sub ---)
        """
    ...
    async def test_should_return_true_when_interval_contained2(self):
        """
        [------ super ------)
        [------ sub ---)
        """
    ...
    async def test_should_return_true_when_interval_contained3(self):
        """
        [------ super ------)
          [------ sub ------)
        """
    ...
    async def test_should_false_true_when_interval_not_contained1(self):
        """
          [---- super ------)
        [------ sub ---)
        """
    ...
    async def test_should_return_false_when_interval_not_contained2(self):
        """
        [------ super ------)
          [---- sub -----------)
        """
    ...
    async def test_should_return_false_when_interval_not_contained3(self):
        """
                                   [------ super ------)
        [---- sub -----------)
        """
    ...
    async def test_is_date_range_in_employee_valid_raises_outside_range(self):
    ...
    async def test_is_date_range_in_employee_valid_inside_range(self):
...
class AsyncTestIntegrationMoveOrgUnitValidator(AsyncTestHelper):
    UNIT_TO_MOVE = "9d07123e-47ac-4a9a-88c8-da82e3a4bc9e"  # Hum

    async def asyncSetUp(self):
        await super().asyncSetUp()

    async def test_cannot_move_unit_to_own_subtree(self):
    ...
    async def test_should_allow_move_unit_to_valid_orgtree_location(self):
    ...
    async def test_should_not_move_root_org_unit(self):
    ...
    async def test_should_not_move_org_unit_to_child(self):
    ...
    async def test_should_return_false_when_candidate_parent_is_inactive(self):
