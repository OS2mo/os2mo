...
class AsyncTestsDelayedMinimal(tests.legacy.cases.AsyncLoRATestCase):
    maxDiff = None
...
@freezegun.freeze_time("2017-01-01", tz_offset=1)
@patch("mora.conf_db.get_configuration", new=lambda *x: {})
class AsyncTestsMinimal(tests.legacy.cases.AsyncLoRATestCase):
    maxDiff = None
...
@freezegun.freeze_time("2017-01-01", tz_offset=1)
@patch("mora.conf_db.get_configuration", new=lambda *x: {})
class AsyncTests(tests.legacy.cases.AsyncLoRATestCase):
    maxDiff = None
...
@freezegun.freeze_time("2017-01-01", tz_offset=1)
@patch("mora.conf_db.get_configuration", new=lambda *x: {})
class TestsMinimal(tests.legacy.cases.LoRATestCase):
    maxDiff = None
...
@freezegun.freeze_time("2017-01-01", tz_offset=1)
@patch("mora.conf_db.get_configuration", new=lambda *x: {})
class Tests(tests.legacy.cases.LoRATestCase):
    maxDiff = None
