...
class NamespaceFilter:
    ...
    def where_clauses(self: "NamespaceFilter") -> list[BinaryExpression[bool]]:
        clauses = []
...
class ListenerFilter:
    ...
    def where_clauses(self: "ListenerFilter") -> list[BinaryExpression[bool]]:
        clauses = []
...
class Namespace:
    ...
    public: bool = strawberry.field(
        description="Whether other can create listeners in the namespace"
    )
