...
if [ "$ENVIRONMENT" = "development" ]; then
    ...
    exec uvicorn --reload --reload-dir=mora/ --reload-dir=oio_rest/ --reload-dir=ramodels/ --host 0.0.0.0 --port 5000 --factory mora.app:create_app --timeout-keep-alive 100 --workers 1
else
