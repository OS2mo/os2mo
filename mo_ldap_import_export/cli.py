...
def generate() -> None:
    ...
    click.echo(commandlist_to_string(generate_ldapsearch_command()))


@ldapsearch.command()
@click.argument("extra", nargs=-1)
def run(extra: tuple[str, ...]) -> None:
    """Generate and run the ldapsearch command.

    If EXTRA arguments are provided they are added to the end of the command.
    """
    ...
    os.system(commandlist_to_string(generate_ldapsearch_command() + list(extra)))
