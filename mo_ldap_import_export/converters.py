    ...
    async def from_ldap(
        ...
        for entry in range(number_of_entries):
            ...
            mo_dict = {
                ...
                # Remove the injector key from the output, as it is not needed to create
                # the objects themselves, rather only later for injection of objects
                if mo_field_name != "_injector_"
            }
