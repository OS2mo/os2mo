...
class DataLoader:
    ...
    async def load_all_mo_objects(
        ...
        filter_types: dict[str, Any] = {
            ...
            "org_units": OrganisationUnitFilter,
            "addresses": AddressFilter,
            "itusers": ITUserFilter,
            "engagements": EngagementFilter,
        }
        readers: dict[str, Callable] = {
            "employees": self.graphql_client.read_all_employee_uuids,
            "org_units": self.graphql_client.read_all_org_unit_uuids,
            "addresses": self.graphql_client.read_all_address_uuids,
            "itusers": self.graphql_client.read_all_ituser_uuids,
            "engagements": self.graphql_client.read_all_engagement_uuids,
        }
