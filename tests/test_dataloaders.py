...
from mo_ldap_import_export.converters import create_engagement_type
from mo_ldap_import_export.converters import create_job_function
...
async def test_create_mo_job_function(dataloader: DataLoader):
    ...
    assert await create_job_function(dataloader, "foo") == uuid2
    assert await create_engagement_type(dataloader, "bar") == uuid2
