...
async def test_rolebinding_sync(
    ...
    await trigger_sync("person2person", alvida.uuid)
    await trigger_sync("person2person", eline.uuid)
    await trigger_sync("person2person", bruce.uuid)
    await trigger_sync("person2person", magnus.uuid)
    ...
    await trigger_sync("itsystem2group", borgerpc.uuid)
    await trigger_sync("role2group", admin.uuid)
    await trigger_sync("role2group", owner.uuid)
