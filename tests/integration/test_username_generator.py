...
async def test_generate_username_use_invalid_username_generator(
    ...
    with monkeypatch.context() as m:
        m.setenv(
            ...
            json.dumps(
                {
                    "username_generator": {
                        "objectClass": "__invalid_username_generator"
                    },
                }
            ),
        )
        # Construct an app and see it explode during lifespan
        fastramqpi = create_fastramqpi()
        app = create_app(fastramqpi=fastramqpi)
