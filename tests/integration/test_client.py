...
@pytest.mark.parametrize(
    ...
    [
        ("read_facet_uuid", {"filter": FacetFilter(uuids=[uuid4()])}),
        ("read_class_uuid", {"filter": ClassFilter(uuids=[uuid4()])}),
        (
            "read_engagements",
            {"uuids": [uuid4()]},
        ),
        (
            "read_engagement_uuids",
            {"engagement_filter": EngagementFilter(employees=[uuid4()])},
        ),
        (
