...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "read_all_org_unit_uuids",
            {"filter": OrganisationUnitFilter(user_keys=["test"])},
        ),
        (
            "read_all_address_uuids",
            {"filter": AddressFilter(user_keys=["test"])},
        ),
        (
            "read_all_ituser_uuids",
            {"filter": ITUserFilter(user_keys=["test"])},
        ),
        (
            "read_all_engagement_uuids",
            {"filter": EngagementFilter(user_keys=["test"])},
        ),
        (
