...
@pytest.mark.freeze_time("2016-01-01", tz_offset=1)
...
@pytest.mark.integration_test
@pytest.mark.freeze_time("2017-06-22", tz_offset=2)
@pytest.mark.usefixtures("fixture_db")
...
def test_update_ituser_partial_update_preserves_engagements(
    ...
    def read_engagement_uuids() -> list[UUID]:
        query = """
    ...
    assert read_engagement_uuids() == engagement_uuids
