...
from mo_ldap_import_export.autogenerated_graphql_client.read_all_ituser_user_keys_by_itsystem_uuid import (
...
async def test_alleroed_dn_generator(
    ...
    graphql_client.read_all_ituser_user_keys_by_itsystem_uuid.return_value = (
        parse_obj_as(ReadAllItuserUserKeysByItsystemUuidItusers, {"objects": []})
    )
