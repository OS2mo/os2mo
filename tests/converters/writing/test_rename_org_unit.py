...
class TestRenameOrgUnit(unittest.TestCase):
    ...
    def test_should_rename_org_unit_correctly_enddate_infinity(self):
        frontend_req = {
            'name': 'A6om',
            'user-key': 'A6',
            'parent-object': {
    ...
    @freezegun.freeze_time('2000-01-01 12:00:00', tz_offset=1)
    def test_should_rename_org_unit_correctly_enddate_final(self):
        frontend_req = {
            'name': 'A6om',
            'user-key': 'A6',
            'parent-object': {
