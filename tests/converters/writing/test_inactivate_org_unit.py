...
class TestInactivateOrgUnit(unittest.TestCase):
    ...
    def test_should_rename_org_unit_correctly(self, mock):
        ...
        actual_output = writing.inactivate_org_unit('65db58f8-a8b9-48e3-b1e3-b0b73636aaa5', '20-05-2017')
        expected_output = expected_output['results'][0][0]['registreringer'][-1]

        self.assertEqual(actual_output, expected_output, 'Unexpected output from inactivate org unit')
